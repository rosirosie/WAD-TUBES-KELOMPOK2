        ...
        <div>
            ...
            <nav class="px-6 space-y-2">
                ...
                <a href="{{ url('/schedules') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-xl transition {{ Request::is('class*') ? 'bg-[#6366f1] text-white shadow-md font-semibold' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700 font-medium' }}">
