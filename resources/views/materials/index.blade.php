...
@section('content')
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4">
                            {{-- TOMBOL UTAMA --}}
                            <button type="button" 
                                    onclick="openQrModal('{{ $material->title }}', '{{ $material->course }}', '{{ asset('storage/' . $material->file_path) }}')" 
                    ...
                    @empty
                    <tr><td colspan="4" class="text-center py-10">Belum ada materi.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
    ...
    <script>
        function openQrModal(title, course, fileUrl) {
